<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMasterPage.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="JobPortal.User.ChangePassword" %>
    ...
    <table>
        ...
        <tr>
         ...
         <tr>
            <td></td>
            <td>
                <asp:Button ID="Button1"  text="Save" runat="server"  OnClientClick="return checkValidation()" OnClick="Button1_Click" />
             </td>
        </tr>
